...
<template>
  <section class="container mx-auto my-4 flex sm:flex-col md:flex-row  space-x-3">
    <div class="p-4 border border-slate-400 rounded">
      ...
      <h4 class="text-2xl my-2">Eating</h4>
      <p>I'm a huge foodlover with healthy body.Always trying to control weight but...</p>
    </div>
